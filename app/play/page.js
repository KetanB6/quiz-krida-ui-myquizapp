...
import { Zap, Loader2, Trophy, RefreshCcw, User, Hash, Play, CheckCircle2, XCircle } from 'lucide-react';
        ...
        <PageContainer>
            ...
            {!quizData ? (
                ...
                <ResultContainer>
                    <ResultHeader>
                        <div className="title-area">
                            <div className={isSubmitted ? "score-badge" : "success-badge"}>
                                {isSubmitted ? <Trophy size={16} /> : <Zap size={16} />}
                                {isSubmitted ? `Final Score: ${score} / ${quizData.questions.length}` : `Topic: ${quizData.quiz.quizTitle}`}
                            </div>
                    ...
                    {!isSubmitted && (
                        <StickyFooter>
                            <SubmitButton onClick={handleSubmitExam} disabled={isLoading}>
                                {isLoading ? <Loader2 className="spinner" /> : "Submit All Answers"}
                            </SubmitButton>
                        </StickyFooter>
                    )}
                </ResultContainer>
...
// --- Styled Components (Premium AI Transparent Blur) ---
