...
const QuickActions = () => {
  ...
  const actions = [
    ...
    { title: "SELECT QUESTIONS", desc: "Select questions from a curated list of topics generated by AI.", icon: <Radio size={20} />, onClick: () => router.push('/selectable-questions') },
